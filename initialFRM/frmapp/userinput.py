class Building:
    ...
    def demo(self):
        ...
        resop = eval(input('does your design have rescue openings? [0/1] \n'))
        # in matlab code: lbc is 30 + input * 30, check it out

        return spr, a, c0, ns, apps, npa, y, h_max, stw, layout, door_air, door_apt, door_stair, sh, ele, s_alarm, aba, fs, glass, warn, lbc, resop

#b = Building()
#spr, a, c0, ns, apps, npa, y, h_max, stw, layout, door_air, door_apt, door_stair, sh, ele, s_alarm, aba, fs, glass, warn, lbc = b.demo()
